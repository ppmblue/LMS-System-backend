...
class ExerciseRecommendation(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        try:
            ...
            recommend = RecommendationsTrial.objects.raw(f"SELECT * FROM recommendations_trial WHERE student_id='{student.secured_student_id}' and outcome_id={outcome.pk}")[0]
